package org.example;
import basketball.CompareTeams;
import basketball.ParsingComand;
...
public class Main {
    ...
    static List <String> heroesTeam1 = new ArrayList <> ();
    static List <String> heroesTeam2 = new ArrayList <> ();
    ...
    public static void main(String[] args) {
        ...
        createHeroes();
        ParsingDotabuff.parsingDotabuff(heroes);
...
//        parsing();
    ...
    Crystal Maiden, Dark Seer, Dark Willow, Dawnbreaker, Dazzle, Death Prophet, Disruptor, Doom, Dragon Knight, Drow Ranger,
    Earth Spirit, Earthshaker, Elder Titan, Ember Spirit, Enchantress, Enigma, Faceless Void, Grimstroke, Gyrocopter, Hoodwink,
    Huskar, Invoker, Io, Jakiro, Juggernaut, Keeper of the Light, Kez, Kunkka, Legion Commander, Leshrac, Lich, Lifestealer,
    Lina, Lion, Lone Druid, Luna, Lycan, Magnus, Marci, Mars, Medusa, Meepo, Mirana, Monkey King, Morphling, Muerta, Naga Siren,
    Nature's Prophet, Necrophos, Night Stalker, Nyx Assassin, Ogre Magi, Omniknight, Oracle, Outworld Destroyer, Pangolier,
    Phantom Assassin, Phantom Lancer, Phoenix, Primal Beast, Puck, Pudge, Pugna, Queen of Pain, Razor, Riki, Ringmaster,
    Rubick, Sand King, Shadow Demon, Shadow Fiend, Shadow Shaman, Silencer, Skywrath Mage, Slardar, Slark, Snapfire, Sniper,
    Spectre, Spirit Breaker, Storm Spirit, Sven, Techies, Templar Assassin, Terrorblade, Tidehunter, Timbersaw, Tinker, Tiny,
    ...
    {
        String hero1Team1 = puck;
        String hero2Team1 = ringmaster;
        String hero3Team1 = kunkka;
        String hero4Team1 = phantom_assassin;
        String hero5Team1 = tinker;

        String hero1Team2 = warlock;
        String hero2Team2 = terrorblade;
        String hero3Team2 = dragon_knight;
        String hero4Team2 = windranger;
        String hero5Team2 = queen_of_pain;

        heroesTeam1.add(hero1Team1);
        heroesTeam1.add(hero2Team1);
        heroesTeam1.add(hero3Team1);
        heroesTeam1.add(hero4Team1);
        heroesTeam1.add(hero5Team1);
